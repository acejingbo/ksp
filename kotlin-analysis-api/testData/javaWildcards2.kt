...
// starList : List<out Any?>
// typeArgList : List<out R>
// numberList : List<out Number>
// stringList : List<String>
// enumList : List<out MyEnum>
// jvmWildcard : List<out [@kotlin.jvm.JvmWildcard] String>
// suppressJvmWildcard : List<out [@kotlin.jvm.JvmSuppressWildcards] Number>
// <init> : VarianceSubject<R>
// R : Any?
// END
